...
# --- PENGATURAN ---
# Arahkan ke folder yang berisi semua file label .txt Anda
LABELS_DIR = "all_labels"

# Definisikan pemetaan dari ID lama ke ID baru
# Format: {id_lama: id_baru}
ID_MAPPING = {
    3: 1,  # Mengubah 'person' dari ID 3 ke 1
    4: 2   # Mengubah 'vest' dari ID 4 ke 2
}
# ------------------
        ...
        for line in lines:
            try:
                ...
                if old_id in ID_MAPPING:
                    ...
                    new_content.append(line) # Simpan baris seperti adanya jika ID tidak perlu diubah
            except (ValueError, IndexError):
                new_content.append(line) # Simpan baris yang aneh/kosong
